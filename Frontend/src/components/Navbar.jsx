    ...
    <nav className="bg-white border-b border-gray-200 shadow-sm sticky top-0 z-50">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-3 flex justify-between items-center">
        ...
        <div className="flex items-center gap-4">
          {!token ? (
            <Link to={"/create-account"} onClick={() => window.scrollTo(0,0)}>
  ...
  whileTap={{ scale: 0.95 }} className="bg-blue-500 px-5 py-2 text-white rounded-full transition">
            ...
            <div className="relative">
              ...
              {profileOpen && (
                <ul className="absolute right-0 mt-7 w-48 bg-white border border-gray-200 rounded-lg shadow-lg text-gray-700">
                  <Link to={"/my-profile"}><li className="px-4 py-2 hover:bg-gray-100 cursor-pointer hover:font-semibold transition">My Profile</li></Link>
                  <Link to={"/my-appointments"}><li className="px-4 py-2 hover:bg-gray-100 cursor-pointer hover:font-semibold transition">My Appointments</li></Link>
                  <li
      ...
      {menuOpen && (
        <div className="md:hidden bg-white border-t border-gray-200 shadow-md">
          <Link to="/home" onClick={() => window.scrollTo(0,0)} className="block px-6 py-3 hover:bg-gray-100 hover:font-semibold transition">Home</Link>
          <Link to="/all-doctors" onClick={() => window.scrollTo(0,0)} className="block px-6 py-3 hover:bg-gray-100 hover:font-semibold transition">All Doctors</Link>
          <Link to="/about-us" onClick={() => window.scrollTo(0,0)} className="block px-6 py-3 hover:bg-gray-100 hover:font-semibold transition">About</Link>
          <Link to="/contact-us" onClick={() => window.scrollTo(0,0)} className="block px-6 py-3 hover:bg-gray-100 hover:font-semibold transition">Contact</Link>
        </div>
      )}
    </nav>
  );
